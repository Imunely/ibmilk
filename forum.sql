...
INSERT INTO `answ` VALUES (25,36,12,'2022-02-13 09:02:24','у тебя ошибка на 10 строке. Ждешь результат callable, но в 20 массив'),(26,37,12,'2022-02-13 09:02:32','<small class=\"text-muted\">\r\n$controller = $this->container->get($controller); // загнали экземпляр класса в контейнер и получили его<br>\r\nreturn [$controller, $action];\r\n</small>\r\n<br>\r\nкак-то так :)'),(27,39,13,'2022-02-13 09:02:57','А у них много вариантов?<br>\r\nРазобрать согласно заранее созданному словарю.<br>\r\nПример<br>\r\nhttps://www.yaplakal.com/forum2/topic308421.html'),(28,40,13,'2022-02-13 07:02:14','Я считаю следует начать с того, чтобы открыть google.com и начать изучать mysql.'),(33,48,16,'2022-02-16 13:59:48','Задача довольно мутно сформулирована, но по-любому ответ - нет.\r\nСтранная идея - решать задачу коммивояжера с помощью SQL'),(34,50,17,'2022-02-16 14:07:02','ЕМНИП там несколько оповещений разного типа происходит. Смотри что в FILE_NOTIFY_INFORMATION возвращается.'),(35,51,17,'2022-02-16 14:09:28','Чем дело закончилось, как решилось?');
...
-- Dump completed on 2022-02-16 16:11:05
